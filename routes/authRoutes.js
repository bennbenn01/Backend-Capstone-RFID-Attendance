...
router.use('/check-pass', customizedRateLimiter.noToken);
...
router.post('/check-pass', csrfProtection, async (req, res) => {
...
router.post('/confirm-pass', csrfProtection, authValidator.confirmPass, passwordValidation, auth.confirmPass);

router.post('/verify-user', csrfProtection, verifyToken, auth.verifyAdmin);

router.post('/refresh', csrfProtection, verifyRefreshToken, auth.refreshAuth);

router.post('/logout', csrfProtection, verifyToken, auth.logoutAdmin);
