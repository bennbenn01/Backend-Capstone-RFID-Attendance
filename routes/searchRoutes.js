...
router.post('/query', verifyToken, searchValidator.query, validateMiddleware, searchController.searchQuery);
router.post('/date-search', verifyToken,  searchValidator.dateSearchQuery, validateMiddleware, searchController.dateSearchQuery);
router.post('/all-date-search', verifyToken, searchValidator.dateSearchQuery, validateMiddleware, searchController.dateSearchQuery);
